...
def merge_excel_files(input_file1, input_file2, output_file, left_on='KEY_COL1', right_on='ucbbl', selected_columns=['ucbbl', 'uc2021']):
  """
  ...
  Args:
      ...
      left_on (str, optional): Column name in the first file for merging. Defaults to 'KEY_COL1'.
      right_on (str, optional): Column name in the second file for merging. Defaults to 'ucbbl'.
      selected_columns (list, optional): List of columns to select from the second file. Defaults to ['ucbbl', 'uc2021'].
  """
  ...
  # Select desired columns from the second file
